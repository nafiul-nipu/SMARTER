  ...
  function attribute_List() {
    ...
    d3.select("#featureModelSelect")
      .on("change", function () {
        ...
        if (value == "OS") {
          d3.select("#predictionImage").attr(
            "src",
            "imgs/CoxForest_OS_default.png"
          );
        } else if (value == "PRG") {
          d3.select("#predictionImage").attr(
            "src",
            "imgs/CoxForest_PFS_default.png"
          );
        }
      })
      .selectAll("option")
        ...
        if (value == "OS") {
          axios({
            ...
            .then(function (response) {
              ...
              // console.log(imgUrl)
              d3.select("#predictionImage").attr("src", imgUrl);
            })
